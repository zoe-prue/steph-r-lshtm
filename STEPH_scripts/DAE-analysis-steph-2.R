...
# TRYING TO REWRITE TO FIT DATASET THAT IS NEWLY FORMATTED WITH 0 AND 1 FOR VARS
...
vascat <- import("vastcat_2025.dta")
total_n = 1137
...
strat_OR_age <- data.frame(category = c("1-11", "12-23", "24-35", "36-47", "48-59"), 
